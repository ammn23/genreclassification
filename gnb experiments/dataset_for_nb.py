...
def load_data():
    ...
    df_30_sec = pd.read_csv("C:\\Users\\User\\Desktop\\Spring 2025\\ml\\genreclassification\\dataset\\features_30_sec.csv")
    df_3_sec = pd.read_csv("C:\\Users\\User\\Desktop\\Spring 2025\\ml\\genreclassification\\dataset\\features_3_sec.csv")
    ...
    X_30_sec_train, X_30_sec_test, y_30_sec_train, y_30_sec_test = train_test_split(df_30_sec, y_30_sec, test_size=0.3, random_state=42)
    X_3_sec_train, X_3_sec_test, y_3_sec_train, y_3_sec_test = train_test_split(df_3_sec, y_3_sec, test_size=0.3, random_state=42)
...
# You can print the shapes to verify the combined data
